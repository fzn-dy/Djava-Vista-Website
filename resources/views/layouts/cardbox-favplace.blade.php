<section class="w-full flex justify-center bg-color7 py-8 ">
    <div class="w-full container 2xl:px-36">
            <div>
                    <p class="text-color4 uppercase px-5">Pilih Paket Wisatamu</p>
                    <p class="text-5xl font-secondary text-color3 px-5">Populer <span class="text-color1">Wisata</span></p>
                    <div class="flex flex-wrap md:justify-between gap-10 px-6 xl:px-0 py-8 lg:px-3 ">
                            <figure class="w-full md:w-[45%] xl:w-[30%] h-[450px] relative photo transition-all duration-1000 ">
                                    ...
                                    <img src="{{ asset('assets/bali.jpeg') }}" alt="" class="w-[100%] h-[100%] object-cover brightness-75 absolute">
                            ...
                            <figure class="w-full md:w-[45%] xl:w-[30%] h-[450px] relative photo transition-all duration-1000 ">
                                    ...
                                    <img src="{{ asset('assets/surabaya.jpg') }}" alt="" class="w-[100%] h-[100%] object-cover brightness-75 absolute">
